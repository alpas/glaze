...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ route; });

// CONCATENATED MODULE: ./js/glaze/UrlBuilder.js
...
var UrlBuilder = /*#__PURE__*/function () {
  function UrlBuilder(name, absolute, glazeObject) {
    ...
    if (typeof this.name === 'undefined') {
      ...
      throw new Error("Glaze Error: route '".concat(this.name, "' is not found in the route list"));
    }
  ...
  _createClass(UrlBuilder, [{
    ...
    value: function setDomain() {
      ...
      var host = (this.route.domain || this.glaze.baseDomain).replace(/\/+$/, '');
...
/* harmony default export */ var glaze_UrlBuilder = (UrlBuilder);
// EXTERNAL MODULE: ./node_modules/qs/lib/index.js
var lib = __webpack_require__(2);

// CONCATENATED MODULE: ./js/glaze/route.js
...
var route_Router = /*#__PURE__*/function (_String) {
  _inherits(Router, _String);

  function Router(name, params, absolute) {
    var _this;

    var customGlaze = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    ...
    _this.glaze = customGlaze ? customGlaze : Glaze;
    _this.urlBuilder = _this.name ? new glaze_UrlBuilder(name, absolute, _this.glaze) : null;
  ...
  route_createClass(Router, [{
    ...
    value: function hydrateUrl() {
      ...
      var hydrated = this.template.replace(/<([^>]+)>/gi, function (tag, i) {
        ...
        if (_this2.glaze.defaultParameters.hasOwnProperty(keyName)) {
          defaultParameter = _this2.glaze.defaultParameters[keyName];
        ...
        if (typeof tagValue === 'undefined') {
          if (tag.indexOf('?') === -1) {
            throw new Error('Glaze Error: \'' + keyName + '\' key is required for route \'' + _this2.name + '\'');
          } else {
            return '';
          }
    ...
    value: function current() {
      ...
      var routeNames = Object.keys(this.glaze.namedRoutes);
      var currentRoute = routeNames.filter(function (name) {
        if (_this3.glaze.namedRoutes[name].methods.indexOf('GET') === -1) {
          return false;
        }

        return new Router(name, undefined, undefined, _this3.glaze).matchUrl();
      })[0];
    ...
    key: "params",
    get: function get() {
      var namedRoute = this.glaze.namedRoutes[this.current()];
...
function route(name, params, absolute, customGlaze) {
  return new route_Router(name, params, absolute, customGlaze);
}
